...
class TestEmail(unittest.TestCase):
    ...
    def test_sending_email(self):
        ...
        datapath = BASE_DIR / 'dispensacion_data.pkl'
        modulepath = BASE_DIR / 'dispensacion_module.pkl'

        # datapath = '/Users/alfonso/Downloads/ajustes_vencimiento_data.pkl'
        # modulepath = '/Users/alfonso/Downloads/ajustes_vencimiento_module.pkl'

        # all_modules = '/Users/alfonso/Projects/migration-sap-medicar/all_modules.pkl'

        with open(datapath, 'rb') as fp:
            data = pickle.load(fp)

        with open(modulepath, 'rb') as fp:
            module = pickle.load(fp)

        e = EmailModule(module, data)
        e.send()
