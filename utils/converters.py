    ...
    def get_contrato(self, row: dict) -> str:
        ...
        match row.get('SubPlan', '').upper().strip():
            ...
            case "CAPITA CONTRIBUTIVO" | "CAPITA COMPLEMENTARIA CONTRIBUTIVO" | "CAPITA BASICA CONTRIBUTIVO":
                return "CAPCON01"
            case "EVENTO NO PBS CONTRIBUTIVO" | "EVENTO PBS CONTRIBUTIVO" | "EVENTO CONTRIBUTIVO" | "EVENTO CONTRIBUTIVA" | "EVENTO PBS CONTRIBUTIVO SIN AUTORIZACION":
                return "EVPBSCON"
            case "EVENTO NO PBS SUBSIDIADO":
                return "EVNOPBSS"
            case "EVENTO PBS SUBSIDIADO" | "EVENTO SUBSIDIADO" | "EVENTO SUBSIDIADA" | "EVENTO PBS SUBSIDIADO SIN AUTORIZACION":
                return "EVPBSSUB"
    ...
    def get_centro_de_costo(self, row: dict, column_name: str, tipo_ajuste=None) -> str:
        ...
        match row.get(column_name, '').upper().strip():
            ...
            case "CAPITA CONTRIBUTIVO" | "CAPITA COMPLEMENTARIA CONTRIBUTIVO":
                return "7165950101"
            case "EVENTO PBS CONTRIBUTIVO" | "CAPITA BASICA CONTRIBUTIVO" | "EVENTO SUBSIDIADO" | "EVENTO CONTRIBUTIVA" | "EVENTO PBS SUBSIDIADO SIN AUTORIZACION":
                return "7165950202"
            case "EVENTO NO PBS SUBSIDIADO":
                return "7165950203"
            ...
            case "MAGISTERIO MEDIFARMA EVENTO" | "MAGISTERIO RAMEDICAS CAPITA" | "MAGISTERIO FARMAT EVENTO":
                return "7165950401"
            case "EVENTO PBS SUBSIDIADO" | "EVENTO CONTRIBUTIVO" |  "EVENTO SUBSIDIADA" | "EVENTO PBS CONTRIBUTIVO SIN AUTORIZACION":
                return "7165950201"
